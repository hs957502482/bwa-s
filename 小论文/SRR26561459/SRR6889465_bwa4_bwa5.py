...
def Optimization_time_nor():
    ...
    samse_time = [11.501,19.216,41.333,75.746]
    samse1_time = [7.107,8.794,13.530,21.570]
    samse2_time = [6.976,7.310,8.997,12.443]
    samse3_time = [6.344,6.996,8.734,12.279]
    samse4_time = [5.187,5.989,8.958,12.302]
    samse5_time = [4.770,5.506,7.633,11.488]
    #occ256
    fig, ax = plt.subplots()
    patterns = ['/', 'o', '*','|','-','+','x', '\\']
