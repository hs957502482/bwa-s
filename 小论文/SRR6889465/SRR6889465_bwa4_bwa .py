...
def Optimization_time_nor():
    ...
    c = plt.bar(x-0.1, samse_time, 0.2,hatch=patterns[0],color = '0.8',edgecolor = 'black',label='samse', align='center')
    ...
    plt.savefig('SRR6889465_samse4_samse.pdf',format='pdf', dpi=1000)
    #plt.show()
