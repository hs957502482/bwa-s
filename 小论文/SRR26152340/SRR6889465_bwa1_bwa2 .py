...
def Optimization_time_nor():
    ...
    #1.52   2.13  2.94   3.27
    # 1.22   1.25     1.51     1.70
    samse_time = [12.130,19.751,42.839,79.713]
    samse1_time = [7.998,9.293,14.589,24.409]
    samse2_time = [6.580,7.418 ,9.659,14.393]
    ...
    plt.savefig('SRR26152340_samse1_samse2.pdf',format='pdf', dpi=1000)
   #plt.show()
