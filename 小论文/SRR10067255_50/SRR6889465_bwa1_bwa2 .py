...
def Optimization_time_nor():
    ...
    #1.42
    #   1.41627461, 1.60744041, 1.69379366, 1.82646358]),
       #[1.02647111, 1.0862925 , 1.20215755, 1.27098317]))
    samse_time = [17.694,31.456,92.823,145.957 ]
    samse1_time = [13.125,21.005,47.464,90.431]
    samse2_time = [12.692,19.969 ,41.527 ,85.305]
    ...
    b = plt.bar(x-0.1, samse1_time, 0.2, hatch=patterns[1],color = '0.8',edgecolor = 'k',label='samse1', align='center')
    #c = plt.bar(x+0.1, bwa1_time, 0.2, color='r', label='bwa1_time', align='center')
    c = plt.bar(x+0.1, samse2_time, 0.2,hatch=patterns[2],color = '0.8',edgecolor = 'black',label='samse2', align='center')
    ...
    plt.savefig('SRR10067255_samse1_samse2.pdf',format='pdf', dpi=1000)
   #plt.show()
