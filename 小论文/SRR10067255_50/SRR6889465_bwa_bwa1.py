...
def Optimization_time_nor():
    ...
    c = plt.bar(x+0.1, samse1_time, 0.2,hatch=patterns[1],color = '0.8',edgecolor = 'black',label='samse1', align='center')
    ...
    plt.savefig('SRR10067255_samse_samse1.pdf',format='pdf', dpi=1000)
   #plt.show()
