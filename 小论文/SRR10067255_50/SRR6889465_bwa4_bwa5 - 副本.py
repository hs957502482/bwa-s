...
def Optimization_time_nor():
    ...
    bwa_time =  [67.976,130.1,324.523,639.566]
    bwa4_timt = [64.044,114.910,264.288,512.744]
    fig, ax = plt.subplots()
    patterns = ['/', 'o', '*','|','-','+','x', '\\']
    ...
    c = plt.bar(x+0.1, bwa4_timt, 0.2,hatch=patterns[4],color = '0.8',edgecolor = 'black',label='BWA*', align='center')
    ...
    plt.savefig('SRR10067255_bwa_bwa4.pdf',format='pdf', dpi=1000)
   #plt.show()
