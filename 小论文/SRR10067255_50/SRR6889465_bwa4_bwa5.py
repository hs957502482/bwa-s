...
def Optimization_time_nor():
    ...
    samse_time = [17.694,31.456,75.823,145.957 ]
    samse1_time = [13.125,21.005,47.464,90.431]
    samse2_time = [12.692,19.969 ,41.527 ,85.305]
    samse3_time = [14.261 ,17.960,28.682,47.560]
    samse4_time = [11.697,12.267,14.796,17.917]
    samse5_time = [10.208,10.977 ,13.192,16.957 ]
    fig, ax = plt.subplots()
    patterns = ['/', 'o', '*','|','-','+','x', '\\']
    ...
    b = plt.bar(x-0.1, samse4_time, 0.2, hatch=patterns[4],color = '0.8',edgecolor = 'k',label='samse4', align='center')
    #c = plt.bar(x+0.1, bwa1_time, 0.2, color='r', label='bwa1_time', align='center')
    c = plt.bar(x+0.1, samse5_time, 0.2,hatch=patterns[5],color = '0.8',edgecolor = 'black',label='samse5', align='center')
    ...
    plt.savefig('SRR10067255_samse4_samse5.pdf',format='pdf', dpi=1000)
   #plt.show()
