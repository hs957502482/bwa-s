...
def Optimization_time_nor():
    ...
    samse_time = [18.879,36.843,76.023,143.986]
    samse1_time = [13.962,22.347,47.911,90.818]
    samse2_time = [13.243,20.965,43.891,83.013]
    ...
    plt.savefig('SRR26828225_samse1_samse2.pdf',format='pdf', dpi=1000)
   #plt.show()
