...
def Optimization_time_nor():
    ...
    b = plt.bar(x-0.1, samse2_time, 0.2, hatch=patterns[2],color = '0.8',edgecolor = 'k',label='samse2', align='center')
    #c = plt.bar(x+0.1, bwa1_time, 0.2, color='r', label='bwa1_time', align='center')
    c = plt.bar(x+0.1, samse3_time, 0.2,hatch=patterns[3],color = '0.8',edgecolor = 'black',label='samse3', align='center')
    ...
    plt.savefig('SRR26828225_samse2_samse3.pdf',format='pdf', dpi=1000)
   #plt.show()
