...
def Optimization_time_nor():
    ...
    samse3_time = [14.797,18.964,32.018,53.389]
    samse4_time = [11.688,12.817,15.857,21.577]
    samse5_time = [10.730,12.602,15.029,19.498]
    bwa_time = [62.377,119.982,276.731,559.627]
    bwa4_time = [57.264,99.95,226.12,447.257]
    fig, ax = plt.subplots()
    patterns = ['/', 'o', '*','|','-','+','x', '\\']
    ...
    b = plt.bar(x-0.1, bwa_time, 0.2, hatch=patterns[0],color = '0.8',edgecolor = 'k',label='BWA', align='center')
    ...
    plt.savefig('SRR26828225_bwa_bwa4.pdf',format='pdf', dpi=1000)
   #plt.show()
