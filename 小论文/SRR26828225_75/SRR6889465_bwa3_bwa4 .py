...
def Optimization_time_nor():
    ...
    b = plt.bar(x-0.1, samse3_time, 0.2, hatch=patterns[3],color = '0.8',edgecolor = 'k',label='samse3', align='center')
    ...
    plt.savefig('SRR26828225_samse3_samse4.pdf',format='pdf', dpi=1000)
   #plt.show()
