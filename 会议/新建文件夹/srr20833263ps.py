...
group4 = [13.891,14.395,14.244,14.433,14.958]#srr20833262   samse3
...
plt.plot(x, group1, marker='o', linestyle='-', color='#4472c4', label='Single thread running time of SRR20833263')
plt.plot(x, group3, marker='s', linestyle='-', color='#ed7d31', label='Four threads running time of SRR20833263')
...
# 显示图表
plt.tight_layout()
plt.savefig('srr20833263ps.pdf', dpi=300) # 保存图表为图片，高分辨率
plt.show()
